      ...
      <View>
        ...
        >
          ...
          >
            ...
            {props.offer.item.thumbnail_url === "" ? (
              <Image
                style={{ width: 70, height: 70 }}
                source={{
                  uri:
                    "https://i.pinimg.com/originals/1c/91/cc/1c91cc7685a7b81c37194068762a66be.png"
                }}
              />
            ) : (
              <Image
                style={{ width: 70, height: 70 }}
                source={{ uri: `${props.offer.item.thumbnail_url}` }}
              />
            )}
          </View>
          <View
          ...
          >
            <Text style={{ fontWeight: "bold", marginTop: 10, width: 150 }}>
            ...
            <Text>
              EARN: $
              {props.offer.item.relationship.payouts.entries[0].payout_amount.toFixed(
                2
              )}
            </Text>
          </View>
          <View style={{ height: 100, alignItems: "center" }}>
            ...
            <Image
              source={{
                uri:
                  "https://www.trzcacak.rs/myfile/full/362-3628000_chevron-svg-transparent-chevron-right-svg.png"
              }}
              style={{ width: 40, height: 50, paddingEnd: 25 }}
            />
          </View>
        </LinearGradient>
      </View>
